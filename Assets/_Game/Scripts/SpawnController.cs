...
public class SpawnController : MonoBehaviour
{
    ...
    [SerializeField] private float topDistance,lateralMaring;
    private Vector2 screenWidth;
    [SerializeField] public Transform allBallsParent;
    ...
    private IEnumerator Spawn(){
        if(gameController.gameStarted){
            ...
            transform.position = new Vector2(Random.Range(-screenWidth.x + lateralMaring, screenWidth.x - lateralMaring),transform.position.y);
